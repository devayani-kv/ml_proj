...
from src.ML_Proj.entity.config_entity import ModelTrainerConfig
from src.ML_Proj.entity.config_entity import ModelEvaluationConfig
...
class ConfigurationManager:
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(
            ...
            target_column = schema.name,
            mlflow_uri="https://dagshub.com/devayanikv14/ml_proj.mlflow",
